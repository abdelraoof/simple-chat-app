...
$(function () {
  ...
  var connected = false;
  var typing = false;
  var lastTypingTime; // get old messages

  var getOldMessages = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(data) {
      var response, responseData, _iterator, _step, oldMessage;
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              _context.next = 4;
              return fetch("/api/messages?room=".concat(room, "&older_than=").concat(loadedAt, "&page=").concat(currentPage, "&token=").concat(user.token));
            ...
            case 7:
              ...
              _iterator = _createForOfIteratorHelper(responseData.data);

              try {
                for (_iterator.s(); !(_step = _iterator.n()).done;) {
                  oldMessage = _step.value;
                  addChatMessage({
    ...
    return function getOldMessages(_x) {
      return _ref.apply(this, arguments);
    };
  }();

  $messages.scroll( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2() {
  ...
  socket.on('login', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              addParticipantsMessage(data); // get old messages
